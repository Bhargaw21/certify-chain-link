...
const Footer = () => {
  return (
    <footer className="w-full py-6 px-6 bg-certify-dark text-white">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">E-Certify</h3>
            <p className="text-sm text-gray-300">
              Blockchain-based certificate validation platform ensuring the authenticity 
              and integrity of educational credentials through decentralized technology.
            </p>
          </div>
